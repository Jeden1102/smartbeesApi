...
<h1 style="margin: 0; color: #555555; font-size: 23px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">SuperSklep - potwierdzenie złożenia zamówienia.</span></h1>
</td>
</tr>
</table>
...
<h1 style="margin: 0; color: #555555; font-size: 23px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Zamówienie złożone pomyślnie. Szczegóły zamówienia:</span></h1>
</td>
</tr>
</table>
...
<li style="margin-bottom: 0px;">Cena: {{ $details['cena'] }}</li>
<li style="margin-bottom: 0px;">Komentarz: {{ $details['comment']}}</li>
<li style="margin-bottom: 0px;">Numer telefonu: {{ $details['phoneNumber']}}</li>
</ul>
</td>
</tr>
</table>
...
<tr>
<td style="width:100%;text-align:center;">
<h1 style="margin: 0; color: #555555; font-size: 23px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Unikalny kod zamówienia :
</span></h1>
</td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="heading_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
	<tr>
	<td style="width:100%;text-align:center;">
	<h1 style="margin: 0; color: #555555; font-size: 23px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">
		<b>{{ $details['order_code'] }}</b> 
	</span></h1>
	</td>
	</tr>
	</table>
...
<p style="margin: 0;">By Dominik Raducki</p>
</div>
</td>
</tr>
</table>
